    ...
    <ErrorBoundary>
      <TooltipProvider>
        ...
        {activeTab && onTabChange && (
          <nav data-tutorial="tab-bar" className="fixed bottom-0 inset-x-0 z-40 pointer-events-none">
            <div className="flex justify-center px-5 pb-[max(0.625rem,env(safe-area-inset-bottom))] pointer-events-auto">
